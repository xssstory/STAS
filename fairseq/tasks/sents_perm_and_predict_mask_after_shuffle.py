...
from fairseq.data import (
    ...
    SentsPermAndPredictMaskDataset
)
from fairseq.data.bert_dictionary import BertDictionary
from . import FairseqTask, register_task

@register_task('perm_and_predict_mask')
class SentsPermAndPredictMaskTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--shuffle-prob', default=0, type=float)
        ...
        parser.add_argument('--fix-ratio', default=0, type=float)
