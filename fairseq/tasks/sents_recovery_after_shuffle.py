...
from fairseq.data import (
    ...
    # ExtractSumBertDataset,
    # ExtractSumBertLongDataset,
    # ExtractSumRobertaLongDataset,
    IndexedRawTextDataset,
    SentsRecoveryAfterShuffle
)

from . import FairseqTask, register_task

@register_task('sents_recovery_after_shuffle')
class SentsRecoveryAfterShuffleTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--shuffle-prob', default=1.0, type=float, help='prob to shuffle the sentences in doc')
    ...
    def load_dataset(self, split, shuffle=True, **kwargs):
        ...
        self.datasets[split] = SentsRecoveryAfterShuffle(
