...
from fairseq.data.finetune_pacsum_v2 import FinetunePacsumDatasetV2
from fairseq.data.bert_dictionary import BertDictionary
from . import FairseqTask, register_task

@register_task('finetune_pacsum_v2')
class FinetunePacsumV2(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--validate-step', default=1000, type=int)
        parser.add_argument('--negative-num', default=5, type=int)
    ...
    def __init__(self, args, src_dict, tgt_dict):
        ...
        self.max_src_size = 0
        self.max_tgt_size = 0
        self.run_dummy_batch = False # set to False for test
    ...
    def load_dataset(self, split, shuffle=True, **kwargs):
        ...
        self.datasets[split] = FinetunePacsumDatasetV2(
            ...
            negative_num=self.args.negative_num,
        )
    ...
    def clear_cuda(self, sample):
        src_size = sum([v.numel() for k, v in sample['net_input']['src_tokens'].items()])
