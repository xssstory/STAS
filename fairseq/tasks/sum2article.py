...
from fairseq.data import GPT2Dictionary
...
def load_langpair_dataset(
    ...
    for k in itertools.count():
        ...
        #     TruncateDataset(tgt_dataset, max_target_positions - 1),
        #     tgt_dict.eos()
        # )
...
@register_task('sum2article')
class Summary2ArticleTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--init-from-pretrained-doc-model', default=False, action='store_true')
        parser.add_argument('--pretrained-doc-model-path', default=None, type=str)
        # fmt: on
    ...
    def setup_task(cls, args, **kwargs):
        ...
        src_dict = GPT2Dictionary.load(os.path.join(paths[0], 'dict.{}.txt'.format(args.source_lang)))
        tgt_dict = GPT2Dictionary.load(os.path.join(paths[0], 'dict.{}.txt'.format(args.target_lang)))
